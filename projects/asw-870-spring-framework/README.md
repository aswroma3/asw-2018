# asw-870-spring-framework

Questo progetto contiene alcune semplici applicazioni 
per introdurre l'uso del [framework Spring](https://projects.spring.io/spring-framework/) 
...
1. posizionarsi nella cartella principale dell'applicazione di interesse - ad esempio `~/projects/asw-870-spring-framework/a-show-xml-configuration`
