...
* **e2-team-rest-client** esemplifica un client Java per il servizio rest **e1-team-rest**

* **e3-team-rest-client-curl** esemplifica un client Curl per il servizio rest **e1-team-rest**

* **f-team-data-jpa** esemplifica l'uso di Spring Data JPA 

* **g-team-data-rest** esemplifica l'uso di Spring Data REST 

* **h-team-data-rest-hateoas** esemplifica l'uso dei link HATEOAS con Spring Data REST
...
1. posizionarsi nella cartella principale dell'applicazione di interesse - ad esempio `~/projects/asw-872-spring-boot/a-hello`
...
Posizionarsi nella cartella principale dell'applicazione, `~/projects/asw-872-spring-boot/j-lucky-word-properties` e poi: 
