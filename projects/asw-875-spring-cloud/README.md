...
* **e-sentence-service** è un'altra versione del servizio per la generazione delle frasi (richiede un gateway) 

* **f-common-zuul-gateway** è un gateway basato su Zuul per accedere al servizio delle frasi 
...
* poi è possibile usare uno (ed una sola istanza) tra i servizi **d**: 
...
* in alternativa ai servizi **d**, è possibile usare una o più istanze 
