...
echo Running SENTENCE [Eureka + Service Discovery]
...
echo Starting Sentence Service [using Service Discovery]

java -Xms64m -Xmx128m -jar d1-sentence-service-discovery/build/libs/sentence-0.0.1-SNAPSHOT.jar &
