...
public class SimpleAsynchConsumer implements Cancellable, MessageListener {
	...
	/* logger */
	private Logger logger = Logger.getLogger("asw.jms.simpleasynchconsumer");
     ...
     */
    public SimpleAsynchConsumer(String n, String d, String cf, SimpleMessageProcessor smp, int maxDelay) {
        this.name = n;
    ...
    public SimpleAsynchConsumer(String n, String d, String cf, SimpleMessageProcessor mp) {
        this(n, d, cf, mp, 0);
    }
	
    public SimpleAsynchConsumer(String n, Destination d, ConnectionFactory cf, SimpleMessageProcessor mp) {
        this(n, d, cf, mp, 0);
    }
